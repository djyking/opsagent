...
export const workspaceActions: readonly WorkspaceAction[] = [
  { id: 'configuration', label: '配置中心', description: '查看 Nacos 配置、实际应用状态和版本，管理员可校验、发布与回退', keywords: ['配置中心', 'Nacos配置', '配置文件', '配置管理', '配置发布', '配置回退'], icon: 'Activity', admin: false, path: '/observability/config' },
  ...
  { id: 'cmdb', label: '服务目录与依赖拓扑', description: '查看服务信息、依赖关系和健康状态', keywords: ['服务目录', '服务拓扑', '拓扑', '依赖', 'CMDB', '服务关系'], icon: 'Network', admin: false, path: '/observability/topology' },
  ...
  { id: 'monitor', label: '服务与观测', description: '核对服务指标、依赖关系和运行配置', keywords: ['运维中心', '监控', '运行状态', '运行风险', '健康检查', '中间件', 'Prometheus', 'Grafana', 'Sentinel', 'Nacos'], icon: 'Activity', admin: false, path: '/observability/topology' },
  { id: 'workflow', label: '持续巡检', description: '查看只读巡检任务与真实采集记录', keywords: ['持续巡检', '只读巡检', '自动巡检', '巡检记录'], icon: 'Activity', admin: false, path: '/observability/inspections' },
