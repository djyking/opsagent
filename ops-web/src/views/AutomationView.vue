...
const tab = ref('runs');
const tabs = [{ id: 'runs', label: '运行与审批', icon: Activity }, { id: 'workflows', label: '工作流与版本', icon: GitBranch },
  { id: 'inspection', label: '持续巡检', icon: Check }, { id: 'tools', label: '模型与工具', icon: Wrench }, { id: 'experience', label: '故障演练', icon: FlaskConical }];
